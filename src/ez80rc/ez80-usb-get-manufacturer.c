...
usb_error_t ez80_usb_get_manufacturer(const uint8_t dev_index, char *const buffer, const uint8_t buffer_size) {
  usb_error_t         result;
  ...
  return usbtrn_get_string(buffer, buffer_size, device_address, my_device_descriptor.iManufacturer);
