...
extern intmax_t imaxabs(intmax_t __n) __NOEXCEPT __attribute__((__const__));

typedef struct {
  intmax_t rem;
  intmax_t quot;
} imaxdiv_t;
extern imaxdiv_t imaxdiv(intmax_t __numer, intmax_t __denom) __NOEXCEPT __attribute__((__const__));
